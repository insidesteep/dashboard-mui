                  ...
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">{uz ? <Avatar variant='square' sx={{width: 16, height: 12}} src="/static/icons/uz.svg" /> : 
                          <IconButton color="primary" aria-label="upload picture" component="span">
                            <AddIcon />
                          </IconButton>
                        }</TableCell>
                        <TableCell align="left">{ru ? <Avatar variant='square' sx={{width: 16, height: 12}} src="/static/icons/ru.svg" /> :   <IconButton color="primary" aria-label="upload picture" component="span">
                            <AddIcon />
                          </IconButton>}</TableCell>
                        <TableCell align="left">{en ? <Avatar variant='square' sx={{width: 16, height: 12}}src="/static/icons/us.svg" /> :   <IconButton color="primary" aria-label="upload picture" component="span">
                            <AddIcon />
                          </IconButton>}</TableCell>
